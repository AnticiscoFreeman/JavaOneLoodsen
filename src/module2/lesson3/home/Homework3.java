...
public class Homework3 {
    ...
    public static void main(String[] args) {
        ...
        int size5 = 10;
        int[] returnArrayFromMethod = returnArray(size5, random.nextInt(size5));
        ...
        int min = findMin(array6);
        System.out.println("6. Minimum: " + min);
        System.out.println("6. Maximum: " + findMax(array6));
        System.out.println("**********");
        ...
        System.out.println("7. Is the " + Arrays.toString(balance) + " balanced? " + (checkBalance(balance) ? "YES" : "NO"));
        System.out.println("**********");
    }
    ...
    public static void change3(int[] array) {
        for (int i = 0; i < array.length; i++) {
            array[i] ^= 1;
        }
    }
